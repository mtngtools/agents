...
## Package-specific agent guidance for `@mtngtools/{PACKAGE-NAME-HERE}`

This file contains only package-specific guidance for automated agents working on the `@mtngtools/{PACKAGE-NAME-HERE}` package. See below for additional guidance.
